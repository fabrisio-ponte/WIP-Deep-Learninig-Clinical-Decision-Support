...
- **Individual Disease Performance**: Detailed metrics for each disease prediction, including threshold-free AP/AUC
...
- **Per-Disease CSV Export**: Flat artifact for manuscript tables and downstream QA
...
### CSV Results
A companion flat file, `comprehensive_disease_analysis_results_per_disease_metrics.csv`, is also written. This is intended for manuscript tables and reproducibility checks, and includes fields such as:
- `disease_code`
